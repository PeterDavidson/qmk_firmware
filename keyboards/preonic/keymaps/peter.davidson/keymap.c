...
[_COLEMAK] = LAYOUT_preonic_grid(
  ...
  KC_LSFT, LCTL_T(KC_Z), LALT_T(KC_X), LSFT_T(KC_C), LTFUN(KC_V), KC_B, KC_K, LMOUSE(KC_M), RSFT_T(KC_COMM), RALT_T(KC_DOT), RCTL_T(KC_UP), KC_RSFT, 
...
[_SYMBOLS] = LAYOUT_preonic_grid(
  ...
  KC_NO, KC_AT, KC_ASTR, KC_EXLM, KC_DQUO, KC_DLR, KC_HASH, KC_SCLN, KC_EQL, KC_UNDS, KC_COLN, KC_DQUO, 
  KC_NO, KC_LCTL, LALT_T(KC_BSLS), KC_CIRC, KC_PIPE, KC_GRV, KC_SPC, KC_TRNS, KC_QUOT, KC_COLN, KC_LT, KC_GT, 
...
[_NUMBERS] = LAYOUT_preonic_grid(
  ...
  KC_NO, KC_LCTL, LALT_T(KC_BSLASH), KC_LCTL, KC_NO, KC_NO, KC_PCMM, KC_1, KC_2, KC_3, KC_UP, KC_NO, 
...
[_NUMPAD] = LAYOUT_preonic_grid(
  ...
  KC_NO, KC_LCTL, LALT_T(KC_BSLASH), KC_LCTL, KC_NO, KC_NO, KC_PCMM, KC_P1, KC_P2, KC_P3, KC_UP, KC_NO, 
...
[_MOVEMENT] = LAYOUT_preonic_grid(
  ...
  KC_NO, KC_NO, KC_NO, KC_NO, KC_LCTL, KC_NO, LCTL(KC_END), KC_END, KC_TAB, KC_TRNS, KC_SCRL, KC_NO, 
...
[_BRACKETS] = LAYOUT_preonic_grid(
  KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, 
  KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, TODEFAULT, KC_NO, LCTL(KC_GRV), LCTL(KC_SLASH), LALT(LSFT(KC_A)),LCTL(LSFT(KC_BSLASH)), KC_NO, 
  KC_NO, KC_LCTL, KC_NO, KC_LALT, KC_LSFT, KC_NO, LCTL(LSFT(KC_BSLASH)),KC_LPRN,        KC_LCBR,        KC_LBRACKET,    KC_LABK, KC_NO, 
